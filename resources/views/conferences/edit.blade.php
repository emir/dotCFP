        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4><i class="fa fa-calendar-o"></i> {{ $conference->name }}</h4>
                </div>
                ...
                <div class="panel-body">
                    ...
                    {!! BootForm::openHorizontal(['sm' => [4, 8], 'lg' => [2, 10]])->action(route('conferences.update', $conference))->put() !!}
                    ...
                    {!! BootForm::select('Timezone', 'timezone')->options($timezones) !!}
                    ...
                    {!! BootForm::text('Airport', 'airport') !!}

                    {!! BootForm::text('Latitude', 'lat') !!}

                    {!! BootForm::text('Longitude', 'lng') !!}
